...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_id'])) {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $errorMsg = "Cannot delete this service. It may be linked to appointments or doctor_services.";
    }
}
...
<div class="page-hero">
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
    <div>
      <h1 class="fw-bold mb-1">Admin: Services</h1>
      <div class="text-muted">Add, edit, and remove clinic services.</div>
    </div>
      ...
      <table class="table align-middle">
        ...
        <?php while ($service = mysqli_fetch_assoc($result)): ?>
          <tr>
            ...
            <td class="text-end">
              <a href="edit_service.php?id=<?= (int)$service['id'] ?>" class="btn btn-sm btn-warning">
                Edit
              </a>

              <form method="POST" class="d-inline">
                <input type="hidden" name="delete_id" value="<?= (int)$service['id'] ?>">
                <button type="submit"
